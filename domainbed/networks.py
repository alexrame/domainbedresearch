...
def MLP2(n_inputs, n_outputs, hparams):
    ...
    if hparams['mlp_depth'] == 1:
        ...
        layers.append(nn.Linear(n_inputs, hparams['mlp_width']))
...
class MLP(nn.Module):
    ...
    def __init__(self, n_inputs, n_outputs, hparams):
        ...
        if activation == "relu":
            ...
            self.activation = nn.LeakyReLU(hparams["mlp_leaky_relu_slope"])
...
def Featurizer(input_shape, hparams):
    ...
    elif hparams["model"] == "pretrained-resnet-18":
        return PretrainedResnet18(pretrained=True, freeze=False)
    elif hparams["model"] == "pretrained-frozen-resnet-18":
        return PretrainedResnet18(pretrained=True, freeze=True)

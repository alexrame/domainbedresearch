...
```sh
python3 -m domainbed.scripts.train --output_dir=./output/swa_officehome_0_single --algorithm SWA --dataset OfficeHome --test_env 0 --hp mav 1 --hp diversity_loss none --data_dir=./data/domainbed/
```
